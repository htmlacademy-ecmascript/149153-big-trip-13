...
render(tripEventsListElement, Object(_view_addForm__WEBPACK_IMPORTED_MODULE_5__["createAddForm"])(), `afterbegin`);

/** Рендерим Точка маршрута */
for (let i = 0; i < POINT_COUNT; i++) {
  render(tripEventsListElement, Object(_view_point__WEBPACK_IMPORTED_MODULE_6__["createPoint"])(), `beforeend`);
}
