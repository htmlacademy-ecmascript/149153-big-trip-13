...
/* harmony import */ var _mock_tripPoint__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./mock/tripPoint */ "./src/mock/tripPoint.js");
...
const points = new Array(POINT_COUNT).fill().map(_mock_tripPoint__WEBPACK_IMPORTED_MODULE_8__["generateTripPoint"]);

/** Рендерим Маршрут и стоимость */
const headerElement = document.querySelector(`.page-header`);
const tripMainElement = headerElement.querySelector(`.trip-main`);

Object(_utils__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(tripMainElement, new _view_information__WEBPACK_IMPORTED_MODULE_0__["default"]().getElement(), _utils__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTEREND);

/** Рендерим Меню */
const tripControlsElement = tripMainElement.querySelector(`.trip-controls`);

Object(_utils__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(tripControlsElement.firstElementChild, new _view_menu__WEBPACK_IMPORTED_MODULE_1__["default"]().getElement(), _utils__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTERBEGIN);

/** Рендерим Фильтры */
Object(_utils__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(tripControlsElement.lastElementChild, new _view_filter__WEBPACK_IMPORTED_MODULE_2__["default"]().getElement(), _utils__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTERBEGIN);

/** Рендерим Сортировку */
const mainElement = document.querySelector(`.page-main`);
const tripEventsElement = mainElement.querySelector(`.trip-events`);

Object(_utils__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(tripEventsElement.firstElementChild, new _view_sort__WEBPACK_IMPORTED_MODULE_3__["default"]().getElement(), _utils__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTERBEGIN);

/** Рендерим Контент */
const content = new _view_content__WEBPACK_IMPORTED_MODULE_4__["default"]();
Object(_utils__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(tripEventsElement, content.getElement(), _utils__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREND);
...
const renderPoint = (pointList , point) => {
  ...
  Object(_utils__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(pointList, pointElement.getElement(), _utils__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREND);
};
