...
/* harmony import */ var _mock_tripPoint__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mock/tripPoint */ "./src/mock/tripPoint.js");
...
const points = new Array(POINT_COUNT).fill().map(_mock_tripPoint__WEBPACK_IMPORTED_MODULE_7__["generateTripPoint"]);
...
render(tripMainElement, Object(_view_information__WEBPACK_IMPORTED_MODULE_0__["createRouteInformation"])(), `afterbegin`);

/** Рендерим Меню */
const tripControlsElement = tripMainElement.querySelector(`.trip-controls`);
const menuElement = tripControlsElement.querySelector(`h2:first-child`);

render(menuElement, Object(_view_menu__WEBPACK_IMPORTED_MODULE_1__["createMenu"])(), `afterend`);

/** Рендерим Фильтры */
const filtersElement = tripControlsElement.querySelector(`h2:last-child`);

render(filtersElement, Object(_view_filter__WEBPACK_IMPORTED_MODULE_2__["createFilters"])(), `afterend`);
...
render(sortElement, Object(_view_sort__WEBPACK_IMPORTED_MODULE_3__["createSortForm"])(), `afterend`);

/** Рендерим Контент */

render(tripEventsElement, Object(_view_content__WEBPACK_IMPORTED_MODULE_4__["createContent"])(), `beforeend`);

/** Рендерим Форму создания */
const tripEventsListElement = tripEventsElement.querySelector(`.trip-events__list`);

render(tripEventsListElement, Object(_view_addForm__WEBPACK_IMPORTED_MODULE_5__["createAddForm"])(points[0]), `afterbegin`);

/** Рендерим Точка маршрута */
for (let i = 1; i < POINT_COUNT; i++) {
  render(tripEventsListElement, Object(_view_point__WEBPACK_IMPORTED_MODULE_6__["createPoint"])(points[i]), `beforeend`);
}
...
/*!*********************************!*\
  !*** ./src/view/information.js ***!
  \*********************************/
/*! exports provided: createRouteInformation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createRouteInformation", function() { return createRouteInformation; });
const createRouteInformation = () => {
...
/*!**************************!*\
  !*** ./src/view/sort.js ***!
  \**************************/
/*! exports provided: createSortForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createSortForm", function() { return createSortForm; });
