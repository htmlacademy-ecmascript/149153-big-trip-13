...
/* harmony import */ var _model_point__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/point */ "./src/model/point.js");
...
const pointModel = new _model_point__WEBPACK_IMPORTED_MODULE_6__["default"]();
...
/** Рендерим Контент */
const tripPresenter = new _presenter_trip__WEBPACK_IMPORTED_MODULE_5__["default"](tripEventsElement, pointModel, filterModel);
const filterPresenter = new _presenter_filter__WEBPACK_IMPORTED_MODULE_2__["default"](tripControlsElement.lastElementChild, filterModel, pointModel);
...
class Filter extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._activeFilter = _utils_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL;
  }
...
class Point extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
class Filter {
  ...
  init() {
    ...
    if (prevFilterComponent === null) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._filterComponent, _utils__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);
      return;
    }

    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._filterComponent, prevFilterComponent);
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["remove"])(prevFilterComponent);
  }
  ...
  _handleFilterTypeChange(filterType) {
    ...
    this._filterModel.setFilter(_utils__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].MAJOR, filterType);
  }
  ...
  _getFilters() {
    ...
    return [
      {
        type: _utils__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL,
        name: `everything`,
        count: _utils__WEBPACK_IMPORTED_MODULE_1__["filter"][_utils__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL](points).length
      },
      {
        type: _utils__WEBPACK_IMPORTED_MODULE_1__["FilterType"].PAST,
        name: `past`,
        count: _utils__WEBPACK_IMPORTED_MODULE_1__["filter"][_utils__WEBPACK_IMPORTED_MODULE_1__["FilterType"].PAST](points).length
      },
      {
        type: _utils__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FUTURE,
        name: `future`,
        count: _utils__WEBPACK_IMPORTED_MODULE_1__["filter"][_utils__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FUTURE](points).length
      },
    ];
  }
}
...
/* harmony import */ var _view_addForm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/addForm */ "./src/view/addForm.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils */ "./src/utils.js");
...
class PointNew {
  ...
  init() {
    ...
    this._pointAddComponent = new _view_addForm__WEBPACK_IMPORTED_MODULE_0__["default"]();
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["render"])(this._pointListContainer, this._pointAddComponent, _utils__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREBEGIN);
  ...
  destroy() {
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._pointAddComponent);
    this._pointAddComponent = null;
  ...
  _handleFormSubmit(point) {
    this._changeData(
        _utils__WEBPACK_IMPORTED_MODULE_1__["UserAction"].ADD_POINT,
        _utils__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].MINOR,
        // Пока у нас нет сервера, который бы после сохранения
        // выдывал честный id задачи, нам нужно позаботиться об этом самим
        Object.assign({id: Object(_utils__WEBPACK_IMPORTED_MODULE_1__["generateId"])()}, point)
    );
    this.destroy();
  }
...
class Point {
  ...
  _handelFormSubmit(update) {
    const isMinorUpdate = !Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDatesEqual"])(this._point.beginDate, update.beginDate) || !Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isDatesEqual"])(this._point.endDate, update.endDate);
    this._changeData(
        _utils__WEBPACK_IMPORTED_MODULE_2__["UserAction"].UPDATE_TASK,
        isMinorUpdate ? _utils__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MINOR : _utils__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].PATCH,
        update);
    this._replaceFormToPoint();
  }
  ...
  _handleFavoriteClick() {
    this._changeData(
        _utils__WEBPACK_IMPORTED_MODULE_2__["UserAction"].UPDATE_TASK,
        _utils__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MINOR,
        Object.assign({}, this._point, {isFavorite: !this._point.isFavorite}));
  }

  _handleDeleteClick(point) {
    this._changeData(
        _utils__WEBPACK_IMPORTED_MODULE_2__["UserAction"].DELETE_POINT,
        _utils__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MINOR,
        point
    );
  }
...
class Trip {
  constructor(routeContainer, pointModel, filterModel) {
    ...
    this._pointNewPresenter = new _point_new__WEBPACK_IMPORTED_MODULE_5__["default"](this._contentComponent, this._handleViewAction);
  }
  init() {
  ...
  createPoint() {
    this._currentSortType = _utils__WEBPACK_IMPORTED_MODULE_3__["SortType"].DAY;
    this._filterModel.setFilter(_utils__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MAJOR, _utils__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL);
  ...
  _getPoints() {
    ...
    const points = this._pointModel.getPoints();
    const filtredPoints = _utils__WEBPACK_IMPORTED_MODULE_3__["filter"][filterType](points);
    switch (this._currentSortType) {
      ...
      case _utils__WEBPACK_IMPORTED_MODULE_3__["SortType"].PRICE:
        return filtredPoints.sort(_utils__WEBPACK_IMPORTED_MODULE_3__["sortPrice"]);
      case _utils__WEBPACK_IMPORTED_MODULE_3__["SortType"].DAY:
        return filtredPoints.sort(_utils__WEBPACK_IMPORTED_MODULE_3__["sortDate"]);
    }
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _utils__WEBPACK_IMPORTED_MODULE_3__["UserAction"].UPDATE_POINT:
        this._pointModel.updatePoint(updateType, update);
        break;
      case _utils__WEBPACK_IMPORTED_MODULE_3__["UserAction"].ADD_POINT:
        this._pointModel.addPoint(updateType, update);
        break;
      case _utils__WEBPACK_IMPORTED_MODULE_3__["UserAction"].DELETE_POINT:
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      case _utils__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].PATCH:
        this._pointPresenter[data.id].init(data);
        break;
      case _utils__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR:
        this._clearTrip();
        this._renderRoute();
        break;
      case _utils__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MAJOR:
  ...
  _renderSort() {
    ...
    this._sortComponent = new _view_sort__WEBPACK_IMPORTED_MODULE_2__["default"](this._currentSortType);
    this._sortComponent.setSortTypeChangeHandler(this._handlerSortTypeChange);

    Object(_utils__WEBPACK_IMPORTED_MODULE_3__["render"])(this._routeContainer.firstElementChild, this._sortComponent, _utils__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTERBEGIN);

  }

  _renderPoint(point) {
    const pointPresenter = new _presenter_point__WEBPACK_IMPORTED_MODULE_4__["default"](this._contentComponent, this._handleViewAction, this._handleModeChange);
  ...
  _clearTrip({resetSortType = false} = {}) {
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._sortComponent);
    Object(_utils__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._noPointsComponent);
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: RenderPosition, renderTemplate, render, createElement, POINT_COUNT, replace, remove, SortType, sortDate, sortPrice, TYPE_TRIP_POINTS, UserAction, UpdateType, isDatesEqual, FilterType, isDateExpired, isDateNotCame, filter, generateId */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isDateExpired", function() { return isDateExpired; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isDateNotCame", function() { return isDateNotCame; });
...
const isDatesEqual = (dateA, dateB) => {
  return (dateA === null && dateB === null) ? true : dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateA).isSame(dateB, `D`);
};
...
const isDateExpired = (date) => {
  return date === null ? false : dayjs__WEBPACK_IMPORTED_MODULE_1___default()().isAfter(date, `D`);
};

const isDateNotCame = (date) => {
  return date === null ? false : dayjs__WEBPACK_IMPORTED_MODULE_1___default()().isBefore(date, `D`);
};
...
class Add extends _smart__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(point) {
    super();
  ...
  _setDatepicker() {
    ...
    this._datepickerBeginDate = flatpickr__WEBPACK_IMPORTED_MODULE_2___default()(
    ...
    this._datepickerEndDate = flatpickr__WEBPACK_IMPORTED_MODULE_2___default()(
  ...
  _beginDateChangeHandler(userDate) {
    this.updateData({
      beginDate: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(userDate).hour(23).minute(59).second(59).toDate()
    });
  }

  _endDateChangeHandler(userDate) {
    this.updateData({
      endDate: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(userDate).hour(23).minute(59).second(59).toDate()
    });
  }
  ...
  <form class="event event--edit" action="#" method="post">
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--destination">
        ...
        <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${he__WEBPACK_IMPORTED_MODULE_4___default.a.encode(city)}" list="destination-list-1">
        <datalist id="destination-list-1">
          <option value="Amsterdam"></option>
          <option value="Geneva"></option>
          <option value="Chamonix"></option>
...
class Edit extends _smart__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _setDatepicker() {
    ...
    this._datepickerBeginDate = flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(
        this.getElement().querySelector(`#event-start-time-1`),
        {
          dateFormat: `d/m/Y H:i`,
          defaultDate: this._data.beginDate,
    ...
    this._datepickerEndDate = flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(
        this.getElement().querySelector(`#event-end-time-1`),
        {
          dateFormat: `d/m/Y H:i`,
          defaultDate: this._data.endDate,
...
const createPointElement = (point) => {
  ...
  <div class="event">
    ...
    <h3 class="event__title">${type} ${he__WEBPACK_IMPORTED_MODULE_2___default.a.encode(city)}</h3>
...
const createSortFormElement = (currentSortType) => {
  return `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
  <div class="trip-sort__item  trip-sort__item--day">
    <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day" ${currentSortType === _utils__WEBPACK_IMPORTED_MODULE_1__["SortType"].DAY ? `checked` : ``} data-sort-type="${_utils__WEBPACK_IMPORTED_MODULE_1__["SortType"].DAY}">
  ...
  <div class="trip-sort__item  trip-sort__item--time">
    <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time" ${currentSortType === _utils__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME ? `checked` : ``} data-sort-type="${_utils__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}">
    <label class="trip-sort__btn" for="sort-time">Time</label>
  </div>

  <div class="trip-sort__item  trip-sort__item--price">
    <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price" ${currentSortType === _utils__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE ? `checked` : ``}data-sort-type="${_utils__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}">
...
class SortForm extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    return createSortFormElement(this._currentSortType);
  }
